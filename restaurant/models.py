...
class Contact(DateMixin, SlugMixin):
    name_and_surname = models.CharField(max_length=255,verbose_name="Adi ve soyadi",null=True,blank=True)
    email = models.EmailField(verbose_name="elektron poctu",null=True,blank=True)
    subject = models.CharField(max_length=255, verbose_name= "Movzu",null=True,blank=True)
