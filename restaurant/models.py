...
class Menu(DateMixin, SlugMixin):
    ...
    image = models.ImageField(upload_to=Uploader.upload_photo_for_menu, verbose_name="Yeməyin şəkili",
                              help_text="80x80")
    food_name = models.CharField(max_length=255, verbose_name="Yeməyin adi")
...
class Contact(DateMixin, SlugMixin):
    name_and_surname = models.CharField(max_length=255, verbose_name="Adi və soyadi", null=True, blank=True)
...
class Reserve(DateMixin, SlugMixin):
    ...
    reserve_date = models.DateTimeField(verbose_name="Rezerv tarixi və saati")
    count_of_guest = models.IntegerField(verbose_name="Qonaq sayi")
